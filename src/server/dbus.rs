...
///
/// Note:
/// On linux, we use dbus to communicate multiple cloudydesk process.
...
const DBUS_NAME: &str = "org.cloudydesk.cloudydesk";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "CloudyDesk DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.cloudydesk.cloudydesk /dbus org.cloudydesk.cloudydesk.NewConnection string:'PEER_ID'`
