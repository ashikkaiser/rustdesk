...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "CloudyDeski võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa CloudyDesk mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et CloudyDesk oma süsteemi paigaldada."),
        ("Click to upgrade", "Vajuta täiendamiseks"),
        ("Configure", "Seadista"),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb CloudyDeskile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb CloudyDeskile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma CloudyDeskile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [CloudyDesk Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep CloudyDesk background service", "Säilita CloudyDeski taustateenus"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele CloudyDeski rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("Show CloudyDesk", "Kuva CloudyDesk"),
        ("This PC", "See arvuti"),
        ("or", "või"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma CloudyDeskile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma CloudyDeskile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud CloudyDeski kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_cloudydesk_password_tip", "Kinnita CloudyDeski parool"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul CloudyDeski kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("upgrade_cloudydesk_server_pro_to_{}_tip", "Palun täienda CloudyDesk Server Pro versioonile {} või uuem!"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib CloudyDeskil takistada juhitud poolel toimimist."),
        ...
        ("powered_by_me", "Põhineb CloudyDeskil"),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui CloudyDeski aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada CloudyDeski taustateenust."),
        ...
        ("About CloudyDesk", "CloudyDeski teave"),
        ...
        ("upgrade_remote_cloudydesk_client_to_{}_tip", "Täiendage CloudyDeski klient kaugküljel versioonile {} või uuemale!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
