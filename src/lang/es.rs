...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conexión a la red CloudyDesk en progreso..."),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que CloudyDesk no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar CloudyDesk a nivel de sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a CloudyDesk de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a CloudyDesk de \"Grabación de pantalla\"."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto controle su dispositivo Android a través del ratón o toque, debe permitir que CloudyDesk use el servicio de \"Accesibilidad\"."),
        ("android_input_permission_tip2", "Vaya a la página de configuración del sistema que se abrirá a continuación, busque y acceda a [Servicios instalados], active el servicio [CloudyDesk Input]."),
        ...
        ("Turned off", "Apagado"),
        ("Language", "Idioma"),
        ("Keep CloudyDesk background service", "Dejar CloudyDesk como Servicio en 2do plano"),
        ...
        ("Show CloudyDesk", "Mostrar CloudyDesk"),
        ("This PC", "Este PC"),
        ("or", "o"),
        ...
        ("config_input", "Para controlar el escritorio remoto con el teclado necesitas dar a CloudyDesk permisos de \"Monitorización de entrada\"."),
        ("config_microphone", "Para poder hablar de forma remota necesitas darle a CloudyDesk permisos de \"Grabar Audio\"."),
        ...
        ("verify_cloudydesk_password_tip", "Verificar la contraseña de CloudyDesk"),
        ...
        ("scam_text1", "Si estás al teléfono con alguien a quien NO conoces y en quien NO confías y te ha pedido que uses CloudyDesk e inicies el servicio, no lo hagas y cuelga inmediatamente."),
        ...
        ("upgrade_cloudydesk_server_pro_to_{}_tip", "¡Por favor, actualiza CloudyDesk Server Pro a la versión {} o superior"),
        ...
        ("selinux_tip", "SELinux está activado en tu dispositivo, lo que puede hacer que CloudyDesk no se ejecute correctamente como lado controlado."),
        ...
        ("powered_by_me", "Con tecnología de CloudyDesk"),
        ...
        ("floating_window_tip", "Ayuda a mantener el servicio de CloudyDesk de fondo"),
        ...
        ("About CloudyDesk", "Acerca de CloudyDesk"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_cloudydesk_client_to_{}_tip", "Por favor, actualiza el cliente CloudyDesk a la versión {} o superior en el lado remoto"),
