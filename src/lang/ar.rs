...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "جاري الاتصال بشبكة CloudyDesk..."),
        ...
        ("install_tip", "بسبب صلاحيات تحكم حساب المستخدم. CloudyDesk قد لا يعمل بشكل صحيح في جهة البعيد في بعض الحالات. لتفادي ذلك. الرجاء الضغط على الزر ادناه لتثبيت CloudyDesk في جهازك."),
        ("Click to upgrade", "اضغط للارتقاء"),
        ("Configure", "تهيئة"),
        ("config_acc", "لتتمكن من التحكم بسطح مكتبك البعيد, تحتاج الى منح CloudyDesk اذونات \"امكانية الوصول\"."),
        ("config_screen", "لتتمكن من الوصول الى سطح مكتبك البعيد, تحتاج الى منح CloudyDesk اذونات \"تسجيل الشاشة\"."),
        ...
        ("android_input_permission_tip1", "لكي يتمكن جهاز بعيد من التحكم بجهازك الـ Android عن طريق الفارة أو اللمس، يلزمك السماح لـ CloudyDesk باستخدام خدمة \"إمكانية الوصول\"."),
        ("android_input_permission_tip2", "يرجى الانتقال إلى صفحة إعدادات النظام التالية، والعثور على [الخدمات المثبتة]، وتشغيل خدمة [CloudyDesk Input]."),
        ...
        ("Turned off", "مطفئ"),
        ("Language", "اللغة"),
        ("Keep CloudyDesk background service", "ابق خدمة CloudyDesk تعمل في الخلفية"),
        ("Ignore Battery Optimizations", "تجاهل تحسينات البطارية"),
        ("android_open_battery_optimizations_tip", "اذا اردت تعطيل هذه الميزة, الرجاء الذهاب الى صفحة اعدادات تطبيق CloudyDesk, ابحث عن البطارية, الغ تحديد غير مقيد"),
        ...
        ("Show CloudyDesk", "عرض CloudyDesk"),
        ("This PC", "هذا الحاسب"),
        ("or", "او"),
        ...
        ("config_input", "لتتمكن من التحكم بسطح المكتب البعيد. يجب من CloudyDesk اذونات \"مراقبة المدخلات\"."),
        ("config_microphone", "لتتمكن من التحدث. يجب منح CloudyDesk اذونات \"تسجيل الصوت\"."),
        ...
        ("still_click_uac_tip", "لازال يحتاج المستخدم البعيد للضغط على موافق في نافذة تحكم حساب المستخدم في CloudyDesk الذي يعمل."),
        ...
        ("verify_cloudydesk_password_tip", "تحقق من كلمة مرور CloudyDesk"),
        ...
        ("upgrade_cloudydesk_server_pro_to_{}_tip", "ترقية خادم CloudyDesk Pro إلى {}"),
        ...
        ("enable-bot-tip", "تمكين البوت للتفاعل مع CloudyDesk"),
        ...
        ("About CloudyDesk", "حول CloudyDesk"),
        ...
        ("upgrade_remote_cloudydesk_client_to_{}_tip", "ترقية عميل CloudyDesk البعيد إلى {}"),
