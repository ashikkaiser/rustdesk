...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem CloudyDesk..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, CloudyDesk v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate CloudyDesku dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate CloudyDesku dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno CloudyDesku dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »CloudyDesk Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep CloudyDesk background service", "Ohrani CloudyDeskovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije CloudyDesk, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "CloudyDesk potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "CloudyDesk potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_cloudydesk_password_tip", "Preveri geslo za CloudyDesk"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite CloudyDesk, prekinite klic in program zaprite."),
        ("scam_text2", "CloudyDesk omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_cloudydesk_server_pro_to_{}_tip", "Prosimo, nadgradite CloudyDesk Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo CloudyDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno CloudyDeska odprto"),
        ...
        ("floating_window_tip", "Pomaga pri CloudyDesk storitvi v ozadju"),
        ...
        ("About CloudyDesk", "O CloudyDesku"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_cloudydesk_client_to_{}_tip", "Prosimo, nadgradite CloudyDesk odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
