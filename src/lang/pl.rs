...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "CloudyDesk może nie działać poprawnie na maszynie zdalnej z przyczyn związanych z UAC. W celu uniknięcia problemów z UAC, kliknij poniższy przycisk by zainstalować CloudyDesk w swoim systemie."),
        ...
        ("Discovered", "Wykryte"),
        ("install_daemon_tip", "By uruchomić CloudyDesk przy starcie systemu, musisz zainstalować usługę systemową."),
        ("Remote ID", "Zdalne ID"),
        ("Paste", "Wklej"),
        ...
        ("android_input_permission_tip1", "Aby można było sterować Twoim urządzeniem za pomocą myszy lub dotyku, musisz zezwolić CloudyDesk na korzystanie z usługi \"Ułatwienia dostępu\"."),
        ("android_input_permission_tip2", "Przejdź do następnej strony ustawień systemowych, znajdź i wejdź w [Zainstalowane usługi], włącz usługę [CloudyDesk Input]."),
        ...
        ("Language", "Język"),
        ("Keep CloudyDesk background service", "Zachowaj usługę CloudyDesk w tle"),
        ("Ignore Battery Optimizations", "Ignoruj optymalizację baterii"),
        ("android_open_battery_optimizations_tip", "Jeśli chcesz wyłączyć tę funkcję, przejdź do następnej strony ustawień aplikacji CloudyDesk, znajdź i wprowadź [Bateria], odznacz [Bez ograniczeń]"),
        ...
        ("Show CloudyDesk", "Pokaż CloudyDesk"),
        ...
        ("config_input", "By kontrolować zdalne urządzenie przy pomocy klawiatury, musisz udzielić aplikacji CloudyDesk uprawnień do \"Urządzeń Wejściowych\"."),
        ...
        ("empty_lan_tip", "Ojej, wygląda na to, że nie odkryliśmy żadnych urządzeń z CloudyDesk w Twojej sieci."),
        ...
        ("verify_cloudydesk_password_tip", "Weryfikuj hasło CloudyDesk"),
        ...
        ("scam_text1", "Jeżeli rozmawiasz przez telefon z osobą której NIE ZNASZ i NIE UFASZ, która prosi Cię o uruchomienie programu CloudyDesk - nie rób tego i natychmiast się rozłącz."),
        ...
        ("upgrade_cloudydesk_server_pro_to_{}_tip", "Proszę zaktualizować CloudyDesk Server Pro do wersji {} lub nowszej!"),
        ...
        ("selinux_tip", "SELinux jest włączony na Twoim urządzeniu, co może przeszkodzić w uruchomieniu CloudyDesk po stronie kontrolowanej."),
        ...
        ("powered_by_me", "Obsługiwane przez CloudyDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Zezwalaj na połączenie tylko wtedy, gdy okno CloudyDesk jest otwarte"),
        ...
        ("floating_window_tip", "Pozwala zachować usługę CloudyDesk w tle"),
        ...
        ("upgrade_remote_cloudydesk_client_to_{}_tip", "Proszę zaktualizować zdalny klient CloudyDesk do wersji {} lub nowszej!"),
