...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Klaar"),
        ("Established", "Opgezet"),
        ("connecting_status", "Verbinding maken met het CloudyDesk netwerk..."),
        ...
        ("install_tip", "Door UAC-beperkingen lukt het niet altijd om uw bureaublad op afstand te bedienen. Installeer CloudyDesk op het systeem om dit probleem te voorkomen."),
        ("Click to upgrade", "Klik voor upgrade"),
        ("Configure", "Configureren"),
        ("config_acc", "Om uw apparaat op afstand te kunnen bedienen, moet u CloudyDesk toestemming voor Toegankelijkheid geven."),
        ("config_screen", "Om uw apparaat op afstand te kunnen bedienen, moet u CloudyDesk toestemming voor Schermopname geven."),
        ...
        ("android_input_permission_tip1", "Om ervoor te zorgen dat een extern apparaat uw Android-apparaat kan besturen via muis of aanraking, moet u CloudyDesk toestaan om de \"Toegankelijkheid\" service te gebruiken."),
        ("android_input_permission_tip2", "Ga naar de volgende pagina met systeeminstellingen, zoek en ga naar [Geïnstalleerde Services], schakel de service [CloudyDesk Input] in."),
        ...
        ("Language", "Taal"),
        ("Keep CloudyDesk background service", "CloudyDesk achtergronddienst behouden"),
        ...
        ("Show CloudyDesk", "Toon CloudyDesk"),
        ("This PC", "Deze PC"),
        ("or", "of"),
        ...
        ("config_input", "Om een extern apparaat met uw toetsenbord te kunnen bedienen, moet u CloudyDesk toestemming voor Invoer Vastleggen geven."),
        ("config_microphone", "Om te kunnen chatten moet u CloudyDesk toestemming voor Microfoon geven."),
        ...
        ("still_click_uac_tip", "De gebruiker op afstand moet altijd bevestigen via het UAC-venster van de werkende CloudyDesk."),
        ...
        ("verify_cloudydesk_password_tip", "Bevestiging wachtwoord CloudyDesk"),
        ...
        ("scam_text1", "Als u aan de telefoon bent met iemand die u NIET kent EN VERTROUWT en die u heeft gevraagd om CloudyDesk te gebruiken en de service te starten, ga dan niet verder en hang onmiddellijk op."),
        ...
        ("upgrade_cloudydesk_server_pro_to_{}_tip", "Upgrade CloudyDesk Server Pro naar versie {} of nieuwer!"),
        ...
        ("selinux_tip", "SELinux is ingeschakeld op dit apparaat, waardoor CloudyDesk mogelijk niet goed functioneert als een gecontroleerde kant."),
        ...
        ("powered_by_me", "Werkt met Cloudydesk"),
        ...
        ("allow-only-conn-window-open-tip", "Alleen verbindingen toestaan als het CloudyDesk-venster geopend is"),
        ...
        ("floating_window_tip", "Helpt CloudyDesk op de achtergrond actief te houden"),
        ...
        ("About CloudyDesk", "Over CloudyDesk"),
        ...
        ("upgrade_remote_cloudydesk_client_to_{}_tip", "Upgrade de CloudyDesk client naar versie {} of nieuwer op de externe computer!"),
