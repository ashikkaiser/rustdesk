...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete CloudyDesk..."),
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), CloudyDesk potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare CloudyDesk a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a CloudyDesk il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a CloudyDesk il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a CloudyDesk di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [CloudyDesk Input]."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep CloudyDesk background service", "Mantieni il servizio di CloudyDesk in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione CloudyDesk, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show CloudyDesk", "Visualizza CloudyDesk"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a CloudyDesk 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a CloudyDesk."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di CloudyDesk."),
        ...
        ("verify_cloudydesk_password_tip", "Conferma password CloudyDesk"),
        ...
        ("Exit", "Esci da CloudyDesk"),
        ("Open", "Apri CloudyDesk"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare CloudyDesk e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_cloudydesk_server_pro_to_{}_tip", "Aggiorna CloudyDesk Server Pro alla versione {} o successiva!"),
        ...
        ("selinux_tip", "In questo dispositivo è abilitato SELinux, che potrebbe impedire il corretto funzionamento di CloudyDesk come lato controllato."),
        ...
        ("powered_by_me", "Alimentato da CloudyDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra CloudyDesk è aperta"),
        ...
        ("floating_window_tip", "Aiuta a mantenere il servizio Cloudydesk in background."),
        ...
        ("About CloudyDesk", "Info su CloudyDesk"),
        ...
        ("upgrade_remote_cloudydesk_client_to_{}_tip", "Aggiorna il client CloudyDesk remoto alla versione {} o successiva!"),
