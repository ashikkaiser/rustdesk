...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Due to UAC, CloudyDesk can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install CloudyDesk to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant CloudyDesk \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant CloudyDesk \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow CloudyDesk to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [CloudyDesk Input] service."),
        ...
        ("doc_mac_permission", "https://cloudydesk.com/docs/en/client/mac/#enable-permissions"),
        ("Ignore Battery Optimizations", "Ignore battery optimizations"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next CloudyDesk application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant CloudyDesk \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant CloudyDesk \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running CloudyDesk."),
        ...
        ("verify_cloudydesk_password_tip", "Verify CloudyDesk password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use CloudyDesk and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_cloudydesk_server_pro_to_{}_tip", "Please upgrade CloudyDesk Server Pro to version {} or newer!"),
        ("pull_group_failed_tip", "Failed to refresh group"),
        ("doc_fix_wayland", "https://cloudydesk.com/docs/en/client/linux/#x11-required"),
        ...
        ("powered_by_me", "Powered by CloudyDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if CloudyDesk window is open"),
        ...
        ("floating_window_tip", "It helps to keep CloudyDesk background service"),
        ...
        ("upgrade_remote_cloudydesk_client_to_{}_tip", "Please upgrade the CloudyDesk client to version {} or newer on the remote side!"),
