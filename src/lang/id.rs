...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke CloudyDesk..."),
        ...
        ("install_tip", "Karena UAC, CloudyDesk tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal CloudyDesk ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Agar bisa mengontrol Desktopmu dari jarak jauh, Kamu harus memberikan izin \"Aksesibilitas\" untuk CloudyDesk."),
        ("config_screen", "Agar bisa mengakses Desktopmu dari jarak jauh, kamu harus memberikan izin \"Perekaman Layar\" untuk CloudyDesk."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android Anda melalui mouse atau sentuhan, Anda harus mengizinkan CloudyDesk untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input CloudyDesk]."),
        ...
        ("Language", "Bahasa"),
        ("Keep CloudyDesk background service", "Pertahankan CloudyDesk berjalan pada service background"),
        ...
        ("Show CloudyDesk", "Tampilkan CloudyDesk"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada CloudyDesk"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada CloudyDesk"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC CloudyDesk yang sedang berjalan"),
        ...
        ("verify_cloudydesk_password_tip", "Verifikasi Kata Sandi CloudyDesk"),
        ...
        ("scam_text1", "Jika anda sedang berbicara di telepon dengan seseorang yang TIDAK dikenal dan mereka meminta anda untuk menggunakan CloudyDesk, jangan lanjutkan dan segera tutup panggilan."),
        ...
        ("upgrade_cloudydesk_server_pro_to_{}_tip", "Silahkan perbarui CloudyDesk Server Pro ke versi {} atau yang lebih baru!"),
        ...
        ("selinux_tip", "pada perangkat anda, SELinux sedang aktif, yang mana itu dapat mencegah CloudyDesk berfungsi dengan baik sebagai sisi yang dikontrol."),
        ...
        ("powered_by_me", "Didukung oleh CloudyDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Koneksi hanya diperbolehkan jika jendela CloudyDesk sedang terbuka."),
        ...
        ("Floating window", ""),
        ("floating_window_tip", "Untuk menjaga layanan/service CloudyDesk agar tetap aktif"),
        ...
        ("About CloudyDesk", "Tentang CloudyDesk"),
        ...
        ("upgrade_remote_cloudydesk_client_to_{}_tip", "Silahkan perbarui aplikasi CloudyDesk ke versi {} atau yang lebih baru pada komputer yang akan terhubung!"),
