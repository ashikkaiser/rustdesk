...
class _DesktopTabState extends State<DesktopTab>
  ...
  void onWindowClose() async {
    ...
    if (isMainWindow) {
      if (cloudyDeskWinManager.getActiveWindows().contains(kMainWindowId)) {
        await cloudyDeskWinManager.unregisterActiveWindow(kMainWindowId);
      }
...
class AddButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ActionIcon(
        ...
        icon: IconFont.add,
        onTap: () => cloudyDeskWinManager.call(
